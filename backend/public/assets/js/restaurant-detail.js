...
async function loadRestaurantDetails() {
    ...
    try {
        ...
        // In monolith, related restaurants can be server-rendered or loaded separately
        // Skip API call - related restaurants should be handled server-side if needed
        console.log('Skipping related restaurants API call in monolith');
        // allRestaurants = []; // Empty array - related restaurants not needed via API
